...
void HPC1_2_order(int a0, int a1, int a2, int b0, int b1, int b2, int* c0, int* c1, int* c2, int r0, int r1, int r2, int p01, int p02, int p12){
...
int main(){
    ...
    int r0, r1, r2;
    // Ri must be shares of 0 (R0^R1^R2 = 0)
    r0 = rand();
    r1 = rand();
    r2 = r0 ^r1; // R share
    ...
    HPC1_2_order(a0, a1, a2, b0, b1, b2, &c0, &c1, &c2, r0, r1, r2, p01, p02, p12);
